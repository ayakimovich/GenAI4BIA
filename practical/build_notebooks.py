...
def main():
    ...
    with open(os.path.join(script_dir, "01_data_download_and_prep.ipynb"), "w") as f:
        json.dump(nb01, f, indent=1)
    print("[+] Created 01_data_download_and_prep.ipynb")
    
    with open(os.path.join(script_dir, "01b_autoencoders_and_vaes.ipynb"), "w") as f:
        json.dump(nb01b, f, indent=1)
    print("[+] Created 01b_autoencoders_and_vaes.ipynb")
    
    with open(os.path.join(script_dir, "02_baseline_regression_unet.ipynb"), "w") as f:
        json.dump(nb02, f, indent=1)
    print("[+] Created 02_baseline_regression_unet.ipynb")
    
    with open(os.path.join(script_dir, "03_generative_pix2pix_gan.ipynb"), "w") as f:
        json.dump(nb03, f, indent=1)
    print("[+] Created 03_generative_pix2pix_gan.ipynb")
    
    with open(os.path.join(script_dir, "04_evaluation_and_benchmarking.ipynb"), "w") as f:
        json.dump(nb04, f, indent=1)
    print("[+] Created 04_evaluation_and_benchmarking.ipynb")
